...
![Interface de WinSCP]({{ site.baseurl }}/images/GUIWinSCP.webp)

![Adresse IP du VPS]({{ site.baseurl }}/images/adresse-ip-vps.webp)
...
![Nom de fichier WGET]({{ site.baseurl }}/images/NomDeFichierWget.webp){:width="80%"}
